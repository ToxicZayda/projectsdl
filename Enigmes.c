...
#include "aEnigmes.h"
/**
@brief initialiser la photo
@param le nom de l'image
@return retourner variable de type photo
*/
...
@param variable de type photo et la position de l'image
@return rien
*/
...
/**
@brief initialiser l'enigme 
@param la reponse justele nom de limage et la reponse juste
@return retourner variable de type enigmes
*/
...
/**
@brief retourner un entier entre 0 et 2
@param rien
...
/**
@brief afficher l'enigme
@param tableau d'enigme et le numero de la fonction aleatoire
@return rien 
*/
...
/**
@brief retourner un entier entre 0 et 2
@param variable de type enigmes , le numero de la fonction aleatoire , event et un entier continuer 
@return retourner un entier (resolution)
*/
